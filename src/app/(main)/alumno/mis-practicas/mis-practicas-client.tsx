...
const getEstadoBadge = (estado: PracticaConDetalles['estado']) => {
  const variants = {
    ...
    'FINALIZADA_PENDIENTE_EVAL': { variant: 'default' as const, label: 'Finalizada', color: 'text-white' },
    ...
    return (
      <div className="text-center py-16 bg-gradient-to-b from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 rounded-2xl border-2 border-dashed border-gray-300 dark:border-gray-600">
        <div className="w-24 h-24 bg-gradient-to-br from-emerald-100 to-teal-100 dark:from-emerald-900/30 dark:to-teal-900/30 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
          <GraduationCap className="w-12 h-12" style={{color: '#007F7C'}} />
        </div>
          ...
          <Card key={practica.id} className="group hover:shadow-xl transition-all duration-300 border border-gray-200 dark:border-gray-700 hover:border-primary/20 overflow-hidden">
            <div className="bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-900/10 dark:to-teal-900/10 px-6 py-4">
              <div className="flex items-start justify-between">
                <div className="flex items-center space-x-3">
                  <div className="w-12 h-12 rounded-xl flex items-center justify-center shadow-lg group-hover:scale-105 transition-transform" style={{background: 'linear-gradient(135deg, #007F7C, #00B0FF)'}}>
            ...
            <CardContent className="p-6 space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-3 p-3 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
                    <div className="w-8 h-8 bg-emerald-100 dark:bg-emerald-900/30 rounded-lg flex items-center justify-center">
                      <User className="w-4 h-4" style={{color: '#007F7C'}} />
                    </div>
                    <div>
              ...
              <div className="pt-6 border-t border-gray-200 dark:border-gray-700">
                <div className="bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-900/10 dark:to-teal-900/10 p-4 rounded-lg">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="text-sm font-bold" style={{color: '#007F7C'}}>
                  ...
                  <div className="flex justify-between text-xs text-gray-500 dark:text-gray-400 mt-2">
                    ...
                    <span className={practica.estado === 'FINALIZADA_PENDIENTE_EVAL' ? 'font-semibold' : ''} style={{color: practica.estado === 'FINALIZADA_PENDIENTE_EVAL' ? '#007F7C' : undefined}}>
                      Finalizada
                    </span>
            ...
            <CardFooter className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800/50 dark:to-gray-700/50 border-t border-gray-200 dark:border-gray-600 p-6">
              <div className="flex flex-col sm:flex-row gap-3 w-full">
                ...
                {practica.estado === 'PENDIENTE' && (
                  <Button asChild size="default" className="flex-1 text-white shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200" style={{backgroundColor: '#007F7C', borderColor: '#007F7C'}}>
                ...
                {puedeSubirInforme(practica.estado) && (
                  <Button asChild size="default" variant="outline" className="flex-1 border-2 hover:bg-emerald-50 dark:hover:bg-emerald-900/10 shadow-md hover:shadow-lg transform hover:scale-105 transition-all duration-200" style={{borderColor: '#007F7C', color: '#007F7C'}}>
                ...
                {practica.estado !== 'PENDIENTE' && (
                  <Button asChild size="default" variant="ghost" className="flex-1 hover:bg-teal-50 dark:hover:bg-teal-900/20 border" style={{color: '#00B0FF', borderColor: '#D0D0D0'}}>
